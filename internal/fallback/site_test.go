...
func TestCaddyChecksumFromFileReturnsSHA512Entry(t *testing.T) {
	tempDir := t.TempDir()
	path := filepath.Join(tempDir, "checksums.txt")
	const asset = "caddy_2.10.2_linux_amd64.tar.gz"
	data := "747df7ee74de188485157a383633a1a963fd9233b71fbb4a69ddcbcc589ce4e2cc82dacf5dbbe136cb51d17e14c59daeb5d9bc92487610b0f3b93680b2646546 " + asset + "\n"
	...
	if sum != "747df7ee74de188485157a383633a1a963fd9233b71fbb4a69ddcbcc589ce4e2cc82dacf5dbbe136cb51d17e14c59daeb5d9bc92487610b0f3b93680b2646546" {
		t.Fatalf("caddyChecksumFromFile = %q, want sha512 entry", sum)
	}
}
